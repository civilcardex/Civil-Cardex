-- UP: agregar flags de etiqueta para ramales/tributarios (ítem 1)
...
-- Actualizar RPC save_plano_data para incluir los nuevos campos
...
-- DOWN
alter table public.cf_planos_ramales drop column if exists show_length;
alter table public.cf_planos_ramales drop column if exists show_name;
alter table public.cf_planos_ramales drop column if exists show_guide;
