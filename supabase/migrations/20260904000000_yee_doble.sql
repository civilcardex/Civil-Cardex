-- Identidad persistida de la yee doble (par de vértices) — el glifo sobrevive al borrado de
-- un brazo/lateral (orig. usuario: borrar T1RS1 borraba el símbolo tras recargar el plano).
-- UP
alter table public.cf_planos_ramales add column if not exists yee_doble jsonb;
