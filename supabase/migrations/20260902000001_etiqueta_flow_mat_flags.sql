-- Nuevos flags de etiqueta: dirección flujo y material/diámetro/pendiente agrupados
-- UP
alter table public.cf_planos_ramales add column if not exists show_flow_dir boolean default true;
alter table public.cf_planos_ramales add column if not exists show_mat_diam_pend boolean default true;
