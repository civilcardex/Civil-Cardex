...
import { GAS_ACCESORIOS } from '../../constants';

interface GasAccesoriosSectionProps {
...
export default function GasAccesoriosSection({ targetId, gasAccMap, incAccGas, decAccGas, accent }: GasAccesoriosSectionProps) {
