  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 6, flex: 1, minHeight: 0 }}>
      <div style={{ display: "flex", gap: 6, justifyContent: "flex-start" }}>
        <button onClick={() => updEP("modo", "red")} style={{ padding: "8px 14px", background: isRed ? "rgba(0,220,229,0.1)" : "transparent", border: `1.5px solid ${isRed ? "#00dce5" : "var(--line)"}`, borderRadius: "var(--r)", color: isRed ? "#00dce5" : "var(--txt3)", cursor: "pointer", fontFamily: "var(--mono)", fontWeight: 700, fontSize: 11, display: "inline-flex", alignItems: "center", gap: 6, textTransform: "uppercase"}}><img src="/iconos_diseno_redes/equipos/succion_red.webp" alt="Succión directa"  width={22} height={22} style={{width:22,height:22}}  loading="lazy" /> Succión directa (red)</button>
        <button onClick={() => updEP("modo", "cisterna")} style={{ padding: "8px 14px", background: !isRed ? "rgba(255,152,0,0.1)" : "transparent", border: `1.5px solid ${!isRed ? "#ff9800" : "var(--line)"}`, borderRadius: "var(--r)", color: !isRed ? "#ff9800" : "var(--txt3)", cursor: "pointer", fontFamily: "var(--mono)", fontWeight: 700, fontSize: 11, display: "inline-flex", alignItems: "center", gap: 6, textTransform: "uppercase" }}><img src="/iconos_diseno_redes/equipos/succion_cisterna.webp" alt="Succión cisterna"  width={22} height={22} style={{width:22,height:22}}  loading="lazy" /> Succión cisterna</button>
      </div>
