    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 6, flex: 1, minHeight: 0 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, alignItems: "start" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <Card style={FLEX_COL} title="📊 Caudales de diseño" subtitle="Del diseño de redes" bodyStyle={{ padding: 0 }}>
          ...
          <Card style={FLEX_COL} title="📐 Presiones y cotas" subtitle="NTC 1500 + levantamiento" bodyStyle={{ padding: 0 }}>
            <Tbl thStyle={{ fontSize: 13 }} tdStyle={{ fontSize: 14 }} tdlStyle={{ fontSize: 15 }} cols={["Parámetro", "Valor", "Ud.", "Comentario / Referencia"]} rows={[
              ...(isRed ? [[
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <Card style={FLEX_COL} title="💧 Pérdidas de carga" subtitle="Del diseño de redes" bodyStyle={{ padding: 0 }}>
            <Tbl thStyle={{ fontSize: 13 }} tdStyle={{ fontSize: 14 }} tdlStyle={{ fontSize: 15 }} cols={["Parámetro", "Valor", "Ud.", "Comentario / Referencia"]} rows={[
          ...
          <Card style={FLEX_COL} title="⚙️ Configuración de bombas" bodyStyle={{ padding: 6, display: "flex", flexDirection: "column", gap: 0 }}>
