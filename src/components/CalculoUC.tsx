    ...
    <>
      <div className="card">
        <div className="card-h">
          <span className="card-t"><img src={`/iconos_diseno_redes/${icon}`} alt="" style={{width:24,height:24,verticalAlign:'middle',marginRight:4}} /> C&aacute;lculo Unidades de Consumo {title}</span>
