  ...
  <>
    <div className="card">
      <div className="card-h">
        <span className="card-t"><img src="/iconos_diseno_redes/RALL_Diseno_red.webp" alt="" style={{width:24,height:24,verticalAlign:'middle',marginRight:4}} /> Diseño de red aguas lluvias</span>
      </div>
