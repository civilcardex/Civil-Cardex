...
function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 flex justify-between items-center px-4 lg:px-6 transition-all duration-500 ease-in-out ${isLandingTop ? 'h-20' : 'h-14 border-b border-outline-variant'}`}
      style={{
    ...
    >
      <div className="flex items-center gap-4 md:gap-6">
        ...
        <Link to="/" className="flex items-center gap-2">
          ...
          />
          <span
            className="font-bold text-xl md:text-2xl tracking-tighter uppercase text-primary"
      ...
      <div className="flex gap-3 items-center">
        {loading ? (
          ...
          <Link
            ...
            style={{ fontFamily: 'Geist, monospace', boxShadow: '0 0 10px rgba(0,245,255,0.1)' }}
          >
            INGRESAR
          </Link>
        )}
