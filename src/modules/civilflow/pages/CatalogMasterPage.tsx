...
export default function CatalogMasterPage() {
  ...
  usePageMeta(
    'Catálogo Maestro',
    'Catálogo de materiales, tuberías y equipos para diseño hidrosanitario. PVC, CPVC, cobre, acero y más según NTC 1500.',
  );
    ...
    >
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          description:
            'Catálogo de materiales, tuberías, accesorios y equipos para diseño hidrosanitario.',
          numberOfItems: [
            ...SANITARIAS,
            ...VENTILACION,
            ...AGUA_FRIA,
      ...
      >
        ...
        >
          <button
            ...
            className="td-mono"
            onClick={() => {
              sessionStorage.setItem('openTab', 'datos');
        ...
        <div
          style={{
            flex: 1,
            minHeight: 0,
            overflow: subpage === 1 ? 'hidden' : 'auto',
            padding: '6px 0',
            display: 'flex',
            flexDirection: 'column',
            gap: 8,
        ...
        >
          ...
          {subpage === 4 && (
            ...
            >
              ...
              <SectionCard
                title="Contra incendio — PVC / Galv."
                subtitle="C900 RDE · Galvanizado"
                compact
              >
        ...
        >
          <button
            ...
            style={{
              ...pageBtn,
              opacity: subpage === 1 ? 0.3 : 1,
              cursor: subpage === 1 ? 'default' : 'pointer',
            }}
          >
            ←
          </button>
