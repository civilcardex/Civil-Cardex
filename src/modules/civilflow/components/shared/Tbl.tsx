...
interface TblProps {
  ...
  caption?: string;
  /** Estilos extra por índice de columna (se funden sobre th/td) — p. ej. ensanchar Valor
   *  y estrechar Fuente/norma. */
  colStyles?: (React.CSSProperties | undefined)[];
}
