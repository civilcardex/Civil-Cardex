  ...
  <>
    <section className="card">
      <div className="card-h">
        <h3 className="card-t"><img src="/iconos_civilflow/diseno_redes/aguas_lluvias/RALL_Diseno_red.webp" alt="Diseño red aguas lluvias"  width={24} height={24} style={{width:24,height:24,verticalAlign:'middle',marginRight:4}}  loading="lazy" /> Diseño de red aguas lluvias</h3>
      </div>
...
const { tKey, id, piso, desde, hasta, bajantesAsociadas, Q, n, sVal, DcalcPulg, DdisPulg, DintMm, Qo, Vo, qqo, Vreal, chequeoV, Yc, Yn, Froude, tipoFlujo, Ymax, chequeoYn, fuerzaTractiva, chequeoFT } = row;
              return(
                <tr key={tKey}>
                  <td className="c" style={{padding:'1px 2px'}}><span className="sigla" style={{fontSize: 10}}>{id || tKey}</span></td>
                  <td className="c" style={{padding:'1px 2px'}}><span style={{fontSize: 10,fontFamily:'var(--mono)',color:'var(--txt2)'}}>{piso ? pisoCorto(piso) : '—'}</span></td>
                  <td className="c" style={{padding:'1px 2px'}}><span style={{fontSize: 10,fontFamily:'var(--mono)',color:'var(--txt2)'}}>{desde || '—'}</span></td>
                  <td className="c" style={{padding:'1px 2px'}}><span style={{fontSize: 10,fontFamily:'var(--mono)',color:'var(--txt2)'}}>{hasta || '—'}</span></td>
          ...
          <select
            ...
            value={DdisPulg||''}
            onChange={e=>handleDiamChange(tKey,id,parseFloat(e.target.value)||0)}
