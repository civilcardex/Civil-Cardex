  ...
  return (
    <section className="card">
      <div className="card-h">
        <h3 className="card-t"><img src="/iconos_civilflow/diseno_redes/general/Accesorios.webp" alt="Accesorios"  width={24} height={24} style={{width:24,height:24,verticalAlign:'middle',marginRight:4}}  loading="lazy" /> Accesorios por ramal</h3>
        <span className="card-s">{tramos.length} tramos</span>
      </div>
      <div style={{padding:'12px'}}>
        <table className="tbl" style={{width:'100%',tableLayout:'fixed',borderCollapse:'collapse',fontSize: 9}}>
          <thead>
            <tr>
              ...
              {ACCESORIOS_COLS.map(a => (
                <th scope="col" key={a.id} className="col-h" style={AccessoriesTable_S5}>
                  <img src={a.icono} alt={a.nombre}  width={16} height={16} style={{width:16,height:16,objectFit:'contain',display:'block',margin:'0 auto 2px'}}  loading="lazy" />
          ...
          <tbody>
            ...
            {tramos.length === 0 && (
              <tr>
                <td className="c" colSpan={1 + ACCESORIOS_COLS.length} style={{fontSize: 9,color:'var(--txt3)',padding:'24px 0',textAlign:'center'}}>
