const TextInputOverlay_S1: React.CSSProperties = {
  position: 'absolute',
  top: 0,
  left: 0,
  right: 0,
...
const TextInputOverlay_S2: React.CSSProperties = {
  background: '#1a1c20',
  border: '2px solid #4D8FF7',
  borderRadius: 8,
  padding: '16px 20px',
  boxShadow: '0 8px 32px rgba(77,143,247,0.25)',
  display: 'flex',
  flexDirection: 'column',
  gap: 10,
  minWidth: 280,
};
const TextInputOverlay_S3: React.CSSProperties = {
  width: '100%',
  padding: '8px 12px',
  background: '#0d0f12',
...
const TextInputOverlay_S4: React.CSSProperties = {
  padding: '5px 14px',
...
const TextInputOverlay_S5: React.CSSProperties = {
  padding: '5px 14px',
  background: '#3578E5',
