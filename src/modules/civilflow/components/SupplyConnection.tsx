...
const SupplyConnection_S1: React.CSSProperties = {
...
const SupplyConnection_S2: React.CSSProperties = {
  width: '100%',
  padding: '3px 4px',
...
const SECTION_COL: React.CSSProperties = {
  display: 'flex',
...
const TH_CENTER: React.CSSProperties = { textAlign: 'center', padding: '2px 6px' };
const TD_PARAM_LABEL: React.CSSProperties = {
  padding: '2px 8px',
  textAlign: 'left',
  fontWeight: 600,
};
const TD_PARAM_VALUE: React.CSSProperties = {
  textAlign: 'center',
  color: 'var(--txt2)',
  fontWeight: 600,
  padding: '1px 2px',
};
const TD_PARAM_UNIT: React.CSSProperties = {
  textAlign: 'center',
  color: 'var(--txt3)',
  padding: '1px 2px',
};
const SCROLL_INNER: React.CSSProperties = {
  display: 'flex',
  flexWrap: 'wrap',
  gap: '16px',
  alignItems: 'stretch',
  ...
  return (
    <section className="card">
      <div className="card-h">
        <h3 className="card-t">
          <img
            src="/iconos_civilflow/diseno_redes/general/Acometida.webp"
            alt="Acometida"
            width={24}
            height={24}
      ...
      <div className="scroll-top" style={{ padding: '16px' }}>
        <div className="scroll-inner" style={SCROLL_INNER}>
          ...
          <div style={{ ...SECTION_COL, flex: '16 1 440px' }}>
            ...
            >
              <thead>
                <tr>
                  ...
                  <th
                    ...
                    className="col-h"
                    colSpan={2}
                    style={{ ...TH_CENTER, fontSize: 10, width: '26%' }}
                  >
                    Longitud (m)
                  </th>
                  <th
              ...
              <tbody>
                {/* ACOM-01 */}
                <tr>
                  <td className="c" style={{ fontWeight: 600, padding: '2px 4px' }}>
                    AC-01
                  </td>
                  <td className="c" style={{ padding: '2px 4px' }}>
                    Red Pública
                  </td>
                  <td className="c" style={{ padding: '2px 4px' }}>
                    Contador
                  ...
                  <td className="c" style={{ padding: '1px' }}>
                    <LazyNum
                      ...
                      className="ni"
                      style={{ width: '100%', textAlign: 'center', fontSize: 10, padding: 2 }}
                    />
                  </td>
                  <td className="c" style={{ padding: '1px' }}>
                    {isTr1Drawn ? (
                      <span
                        style={{ fontFamily: 'var(--mono)', fontSize: 10, color: 'var(--txt2)' }}
                      >
                        {fmt(acoL1.le, 2)}
                      </span>
                    ) : (
                ...
                <tr>
                  ...
                  <td
                    className="c"
                    style={{ padding: '2px 4px', borderBottom: '1px solid var(--line)' }}
                  >
                    Contador
                  </td>
                  <td
                    className="c"
                    style={{ padding: '1px', borderBottom: '1px solid var(--line)' }}
                  >
                    {isTr2Drawn ? (
                      <span
                        style={{ fontFamily: 'var(--mono)', fontSize: 10, color: 'var(--txt2)' }}
                      ...
                      <input
                        ...
                        value={acoMonName}
                        onChange={(e) => setAcoMonName(e.target.value)}
                        className="ni"
          ...
          <div style={{ ...SECTION_COL, flex: '8 1 240px' }}>
            ...
            <table
              className="tbl"
              style={{ fontSize: 12, width: '100%', tableLayout: 'fixed', borderBottom: 'none' }}
            >
              <thead>
                <tr>
              ...
              <tbody>
                ...
                <tr>
                  <td style={{ ...TD_PARAM_LABEL, borderBottom: '1px solid var(--line)' }}>
                    Caudal nominal (Qn)
                  </td>
                  <td
                    className="c"
                  ...
                  <td
                    className="c"
                    style={{ ...TD_PARAM_UNIT, borderBottom: '1px solid var(--line)' }}
                  >
                    L/s
                  </td>
                </tr>
            ...
            >
              ...
              <tbody>
                ...
                <tr>
                  ...
                  >
                    {fmt(f1.Pfin)} <span style={{ fontSize: 9, color: 'var(--txt3)' }}>mca</span>
                  </td>
                </tr>
                <tr>
                  <td style={{ fontWeight: 600, padding: '3px 4px', textAlign: 'left' }}>
                    AC-02 Presión Inicial
                  </td>
                  <td
                    style={{
                      textAlign: 'right',
                ...
                <tr>
                  ...
                  >
                    {fmt(f2.Pfin)} <span style={{ fontSize: 9, color: 'var(--txt3)' }}>mca</span>
                  </td>
                </tr>
                <tr>
                  <td style={{ fontWeight: 600, padding: '3px 4px', textAlign: 'left' }}>
                    Pérdidas en contador &le; Pérdidas máximas
                  </td>
                  <td style={{ textAlign: 'right', padding: '2px 4px' }}>
                    <div
                      style={{
                ...
                <tr>
                  ...
                  <td
                    style={{
                      ...
                      fontWeight: 800,
                      background:
                        okPresion && hfContador <= acoHfMax
                          ? 'rgba(34,197,94,0.15)'
                          : 'rgba(239,68,68,0.15)',
                      color: okPresion && hfContador <= acoHfMax ? 'var(--succ)' : 'var(--err)',
                      padding: '4px',
                      letterSpacing: 0.5,
                      borderBottom: '1px solid var(--line)',
                    }}
