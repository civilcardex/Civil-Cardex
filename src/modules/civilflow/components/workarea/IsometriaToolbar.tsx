...
const IsometriaToolbar_S2: React.CSSProperties = {
  padding: '3px 8px',
  fontSize: 12,
...
const IsometriaToolbar_S3: React.CSSProperties = {
  padding: '3px 8px',
  fontSize: 12,
  fontFamily: 'Geist,monospace',
  borderRadius: 3,
...
const IsometriaToolbar_S4: React.CSSProperties = {
  position: 'absolute',
  top: '100%',
  left: 0,
  zIndex: 100,
...
const IsometriaToolbar_S5: React.CSSProperties = {
  padding: '4px 8px',
  fontSize: 12,
  fontFamily: 'Geist,monospace',
  border: 'none',
...
const IsometriaToolbar_S6: React.CSSProperties = {
  padding: '4px 8px',
  fontSize: 12,
  fontFamily: 'Geist,monospace',
  border: 'none',
...
const IsometriaToolbar_planosLabel: React.CSSProperties = {
  display: 'flex',
  alignItems: 'center',
  gap: 4,
  fontSize: 12,
...
export default function IsometriaToolbar({
  ...
  return (
    ...
    >
      ...
      <label
        style={{
          ...IsometriaToolbar_planosLabel,
          border: `1px solid ${showPlanos ? '#4D8FF7' : '#3a494a'}`,
          background: showPlanos ? 'rgba(77,143,247,.15)' : 'transparent',
        }}
      >
        <input
          type="checkbox"
          checked={showPlanos}
          onChange={(e) => setShowPlanos(e.target.checked)}
          style={{ accentColor: '#4D8FF7', margin: 0 }}
        />
        Planos ({planosCount})
      </label>
      ...
      >
        <label htmlFor="iso-rotx" style={{ margin: 0 }}>
          Giro vertical
        </label>
        <button
          type="button"
          ...
          style={{
            ...
            border: '1px solid #3a494a',
            cursor: 'pointer',
            background: rotX === -30 ? '#4D8FF7' : '#1e2024',
            color: rotX === -30 ? '#fff' : '#b9caca',
          }}
        >
          -30°
        </button>
        <button
          ...
          style={{
            ...
            border: '1px solid #3a494a',
            cursor: 'pointer',
            background: rotX === -45 ? '#4D8FF7' : '#1e2024',
            color: rotX === -45 ? '#fff' : '#b9caca',
          }}
        >
          -45°
        </button>
      ...
      >
        <label htmlFor="iso-rotz" style={{ margin: 0 }}>
          Giro horizontal
        </label>
        <button
          type="button"
          ...
          style={{
            ...
            border: '1px solid #3a494a',
            cursor: 'pointer',
            background: rotZ === 30 ? '#4D8FF7' : '#1e2024',
            color: rotZ === 30 ? '#fff' : '#b9caca',
          }}
        >
          30°
        </button>
        <button
          ...
          style={{
            ...
            border: '1px solid #3a494a',
            cursor: 'pointer',
            background: rotZ === 45 ? '#4D8FF7' : '#1e2024',
            color: rotZ === 45 ? '#fff' : '#b9caca',
          }}
        >
          45°
        </button>
      ...
      <button type="button" onClick={fitView} title="Encuadrar todo" style={IsometriaToolbar_S2}>
        ⊞
      </button>
