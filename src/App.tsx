  ...
  return (
    <AppProviders>
      <ErrorBoundary>
        ...
        <main id="app-content" className="min-h-screen bg-surface-bg text-on-surface font-sans">
          <Routes>
            ...
            <Route path="/civilflow" element={<Suspense fallback={<Fallback />}><CivilFlowPage /></Suspense>} />
            <Route path="/civilstructure" element={<Suspense fallback={<Fallback />}><CivilStructurePage /></Suspense>} />
            <Route path="/civilterrain" element={<Suspense fallback={<Fallback />}><CivilTerrainPage /></Suspense>} />
            <Route path="/civilbim" element={<Suspense fallback={<Fallback />}><CivilBIMPage /></Suspense>} />
            <Route path="/civilmanage" element={<Suspense fallback={<Fallback />}><CivilManagePage /></Suspense>} />
            <Route path="/civilmep" element={<Suspense fallback={<Fallback />}><CivilMEPPage /></Suspense>} />
            <Route path="/civilroads" element={<Suspense fallback={<Fallback />}><CivilRoadsPage /></Suspense>} />
