...
export const REDES=[
  ...
  {id:'recolectora',lbl:'Canal recolectora', sub:'Subred aguas lluvias · Recolectora', ico:'🏠', icoImg:'/iconos_diseno_redes/aguas_lluvias/RALL_Chequeo_canal_cubierta.webp', col:'var(--ll)'},
