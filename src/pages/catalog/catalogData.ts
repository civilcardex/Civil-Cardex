...
export const RCI = [
  { mat: 'Acero al carbono SCH 10', rows: [
    { dn: '¾"', d: 22.48 }, { dn: '1"', d: 27.86 }, { dn: '1¼"', d: 36.66 },
    { dn: '1 ½"', d: 42.76 }, { dn: '2"', d: 54.76 }, { dn: '2 ½"', d: 66.9 },
    { dn: '3"', d: 82.8 }, { dn: '4"', d: 108.2 }, { dn: '5"', d: 134.5 },
    { dn: '6"', d: 161.5 }, { dn: '8"', d: 209.54 }, { dn: '10"', d: 263.44 },
  ]},
  { mat: 'Acero al carbono SCH 40', rows: [
    { dn: '½"', d: 15.76 }, { dn: '¾"', d: 20.96 }, { dn: '1"', d: 26.64 },
    { dn: '1¼"', d: 35.08 }, { dn: '1 ½"', d: 40.94 }, { dn: '2"', d: 52.48 },
    { dn: '2 ½"', d: 62.68 }, { dn: '3"', d: 77.92 }, { dn: '4"', d: 102.26 },
  ...
  { mat: 'Acero galvanizado', rows: [
    { dn: '¾"', d: 22.48 }, { dn: '1"', d: 27.86 }, { dn: '1¼"', d: 36.66 },
    { dn: '1 ½"', d: 42.76 }, { dn: '2"', d: 54.76 }, { dn: '2 ½"', d: 66.90 },
    { dn: '3"', d: 82.80 }, { dn: '3 ½"', d: 95.50 }, { dn: '4"', d: 108.20 },
    { dn: '6"', d: 161.50 },
  ]},
];
...
export const AGUA_FRIA = [
  { mat: 'PVC-Pr', rows: [
    { dn: '½ (RDE 9)', d: 16.60 }, { dn: '½ (RDE 13.5)', d: 18.18 },
    { dn: '¾ (RDE 11)', d: 21.81 }, { dn: '¾ (RDE 21)', d: 23.63 },
    { dn: '1 (RDE 13.5)', d: 28.48 }, { dn: '1 (RDE 21)', d: 30.20 },
    { dn: '1¼ (RDE 21)', d: 38.14 }, { dn: '1 ½ (RDE 21)', d: 43.68 },
    { dn: '2 (RDE 21)', d: 54.58 }, { dn: '2 ½ (RDE 21)', d: 66.07 },
...
export const AGUA_CALIENTE = [
  { mat: 'CPVC', rows: [
    { dn: '½ (RDE 11)', d: 12.40 }, { dn: '¾ (RDE 11)', d: 18.20 },
    { dn: '1 (RDE 11)', d: 23.40 }, { dn: '1¼ (RDE 11)', d: 28.60 },
    { dn: '1 ½ (RDE 11)', d: 33.70 }, { dn: '2 (RDE 11)', d: 44.20 },
    { dn: '2 (CPVC SCH 80)', d: 49.25 },
    { dn: '2 ½ (CPVC SCH 80)', d: 59.00 },
...
export const COEF_FRICCION = [
  ...
  { tipo: 'Acero galvanizado', desc: 'Acero galvanizado', sis: 'Gas', mat: 'Acero', n: 0.015, c: 120, cu: 100, e: 0.1500, pn: 'Según cédula' },
  ...
  { tipo: 'Acero al carbono', desc: 'Acero negro', sis: 'Contra incendio', mat: 'Acero', n: 0.012, c: 120, cu: 100, e: 0.0450, pn: 'Según cédula' },
  { tipo: 'Acero galvanizado', desc: 'Acero galvanizado', sis: 'Contra incendio', mat: 'Acero', n: 0.015, c: 120, cu: 100, e: 0.1500, pn: 'Según cédula' },
